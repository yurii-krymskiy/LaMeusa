...
const SeoPasta = () => {
    ...
    return (
        <>
                ...
                <div className="container">
                    <div className="mb-10 max-w-[800px]">
                        <h1 className="title hero-title md:!text-left">
                            {t("seoPages.pasta.hero.title")}
                        </h1>
                        <p className="description hero-description !ml-0 md:!text-left">
                            {t("seoPages.pasta.hero.description")}
                        </p>
                    </div>
                        ...
                        <div className="text-center">
                            ...
                            <div>
                                <h3 className="title mb-2.5 inline-block text-lg md:text-xl">
                                    {t("seoPages.pasta.why.feature1Title")}
                                </h3>
                                <p className="description md:text-lg">
                                    {t("seoPages.pasta.why.feature1Desc")}
                                </p>
                            </div>
                        </div>
                        <div className="text-center">
                            ...
                            <div>
                                <h3 className="title mb-2.5 inline-block text-lg md:text-xl">
                                    {t("seoPages.pasta.why.feature2Title")}
                                </h3>
                                <p className="description md:text-lg">
                                    {t("seoPages.pasta.why.feature2Desc")}
                                </p>
                            </div>
                        </div>
                        <div className="text-center">
                            ...
                            <div>
                                <h3 className="title mb-2.5 inline-block text-lg md:text-xl">
                                    {t("seoPages.pasta.why.feature3Title")}
                                </h3>
                                <p className="description md:text-lg">
                                    {t("seoPages.pasta.why.feature3Desc")}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="container">
                    <div className="flex flex-col items-center gap-5 lg:flex-row lg:gap-24">
                        <img
                            src="/IMG_3093.jpeg"
                            loading="lazy"
                            alt={t("seoPages.pasta.hours.title")}
                        ...
                        <div>
                            <div className="mb-5 lg:mb-10">
                                <h2 className="section-title title mb-7 inline-block">
                                    {t("seoPages.pasta.hours.title")}
                                </h2>
                                <p className="section-description description">
                                    {t("seoPages.pasta.hours.description")}
                                </p>
                            </div>
            ...
            {/* Meets */}
            <SeoKitchenSection
                decorative={t("seoPages.pasta.kitchen.decorative")}
                title={t("seoPages.pasta.kitchen.title")}
                image1="/IMG_3440.jpeg"
                image2="/IMG_3438.jpeg"
                paragraphs={[
                    t("seoPages.pasta.kitchen.p1"),
                    t("seoPages.pasta.kitchen.p2"),
                    t("seoPages.pasta.kitchen.p3"),
                ]}
            />
                ...
                <div className="container flex flex-col items-center lg:flex-row">
                    ...
                    <div className="lg:-ml-10">
                        <div className="mb-5 lg:mb-10">
                            ...
                            <h2 className="title section-title">
                                {t("seoPages.pasta.reserve.title")}
                            </h2>
                            <p className="description section-description mb-2">
                                {t("seoPages.pasta.reserve.p1")}
                            </p>
                            <p className="description section-description">
                                {t("seoPages.pasta.reserve.p2")}
                            </p>
                        </div>
                        <ButtonOpenReservation variant="blue">
