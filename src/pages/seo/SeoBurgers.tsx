                ...
                <div className="container">
                    <div className="mb-10 max-w-[800px]">
                        <h1 className="title hero-title md:!text-left">
                            {t("seoPages.burgers.hero.title")}
                        </h1>
                        <p className="description hero-description !ml-0 md:!text-left">
                            {t("seoPages.burgers.hero.description")}
                        </p>
                    </div>
                        ...
                        <div className="text-center">
                            ...
                            <div>
                                <h3 className="title mb-2.5 inline-block text-lg md:text-xl">
                                    {t("seoPages.burgers.why.feature1Title")}
                                </h3>
                                <p className="description md:text-lg">
                                    {t("seoPages.burgers.why.feature1Desc")}
                                </p>
                            </div>
                        </div>
                        <div className="text-center">
                            ...
                            <div>
                                <h3 className="title mb-2.5 inline-block text-lg md:text-xl">
                                    {t("seoPages.burgers.why.feature2Title")}
                                </h3>
                                <p className="description md:text-lg">
                                    {t("seoPages.burgers.why.feature2Desc")}
                                </p>
                            </div>
                        </div>
                        <div className="text-center">
                            ...
                            <div>
                                <h3 className="title mb-2.5 inline-block text-lg md:text-xl">
                                    {t("seoPages.burgers.why.feature3Title")}
                                </h3>
                                <p className="description md:text-lg">
                                    {t("seoPages.burgers.why.feature3Desc")}
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div>
                            <div className="mb-5 lg:mb-10">
                                <h2 className="section-title title mb-7 inline-block">
                                    {t("seoPages.burgers.hours.title")}
                                </h2>
                                <p className="section-description description">
                                    {t("seoPages.burgers.hours.description")}
                                </p>
                            </div>
                ...
                <div className="container flex flex-col items-center lg:flex-row">
                    ...
                    <div className="lg:-ml-10">
                        <div className="mb-5 lg:mb-10">
                            ...
                            <h2 className="title section-title">
                                {t("seoPages.burgers.reserve.title")}
                            </h2>
                            <p className="description section-description mb-2">
                                {t("seoPages.burgers.reserve.p1")}
                            </p>
                            <p className="description section-description">
                                {t("seoPages.burgers.reserve.p2")}
                            </p>
                        </div>
                        <ButtonOpenReservation variant="blue">
