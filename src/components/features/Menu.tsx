                ...
                >
                    <div
                        className={[
                            ...
                            "flex flex-col md:justify-center overflow-y-hidden overscroll-contain pt-20 lg:py-20 [-webkit-overflow-scrolling:touch] md:items-center",
                    ...
                    >
                        ...
                        <div className="overflow-y-auto w-full">
                            <div className="mx-auto flex w-full max-w-5xl items-center justify-between px-4">
                                <ul className="flex flex-col gap-3.5 lg:gap-9 text-2xl font-semibold text-white uppercase md:text-3xl">
